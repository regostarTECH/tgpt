...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6811858241:AAFM3M62DbLUwO6iDUZr_GCRlulht-8sh50"
else:
    tgkey = tgenv
print(tgenv)
...
def start(bot, update):
    ...
    if tim == 1:
        ...
        qcache = None
        botname = 'Saber AI'
        username = 'SaberAIROBot'
        update.message.reply_text('Salom Saber AI')
        return 
    else:
        update.message.reply_text('Men hozir boshqa birov bilan gaplashyapman. Iltimos ' + left + ' soniya kuta olasizmi?')
        return
